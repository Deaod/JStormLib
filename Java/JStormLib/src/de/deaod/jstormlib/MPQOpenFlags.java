...
public class MPQOpenFlags {
    ...
    private EnumSet<MPQOpenFlag> openFlags      = EnumSet.noneOf(MPQOpenFlag.class);
    ...
    public void setOpenFlags(EnumSet<MPQOpenFlag> openFlags) {
    ...
    int getFlags() {
        ...
        Iterator<MPQOpenFlag> it = this.openFlags.iterator();
        while (it.hasNext()) {
            MPQOpenFlag flag = it.next();
